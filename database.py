...
class Database:
    ...
    def add_account(self, account: Dict) -> bool:
        ...
        conn = self.get_connection()
        cursor = conn.cursor()
        # Check if account with same phone already exists (normalize phone for comparison)
...
if __name__ == "__main__":
    ...
    # ============================================================================
    # CAMPAIGN IMPROVEMENTS - Account Limits & Worker Pool Support
    # ============================================================================
...
def get_account_campaign_limit(self, campaign_id: int, account_phone: str) -> Optional[Dict]:
...
def get_campaign_account_limits(self, campaign_id: int) -> List[Dict]:
...
def get_next_campaign_user(self, campaign_id: int) -> Optional[Dict]:
    ...
    try:
        ...
        if row:
            user = dict(row)
            # Mark as processing to prevent other workers from taking it
            cursor.execute(
...
def count_campaign_users_by_status(self, campaign_id: int, status: str) -> int:
...
def delete_campaign_user_by_id(self, user_id: int) -> bool:
